...
import org.usfirst.frc.team1155.robot.commands.DriveDistance;
import org.usfirst.frc.team1155.robot.commands.TurnToDegree;
...
public class OI {
	...
	public OI() {
		...
		turnDegreeButton.whenReleased(new DriveCommand(stick));
		driveDistanceButton.whenReleased(new DriveCommand(stick));
		// Release to drive.
	}
	//// CREATING BUTTONS
